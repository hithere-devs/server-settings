...
alias glg="git log --oneline"   # Short git log
alias gpull="git pull"          # Git pull
alias gadd="git add ."          # Git add all

alias dev="cd /Users/azhar/Development"

  export NVM_DIR="$HOME/.nvm"
  [ -s "/opt/homebrew/opt/nvm/nvm.sh" ] && \. "/opt/homebrew/opt/nvm/nvm.sh"  # This loads nvm
  [ -s "/opt/homebrew/opt/nvm/etc/bash_completion.d/nvm" ] && \. "/opt/homebrew/opt/nvm/etc/bash_completion.d/nvm"  # This loads nvm bash_completion

  export BUN_INSTALL="/home/kevinforrestconnors/.bun"
export PATH="$BUN_INSTALL/bin:$PATH"

alias ogo="cd /Users/azhar/Development/LearningGo"
